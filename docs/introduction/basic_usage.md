...
All ```so4gp``` functions and classes are documented in the [API Function Reference](api/functions), and algorithms are documented in the [API Algorithm Reference](api/algorithms).
