...
if __name__ == "__main__":
    ...
    mine_obj = sgp.algorithms.GRAANK(dummy_df, min_sup=0.5, eq=False)
    # mine_obj = sgp.algorithms.ClusterGP(dummy_df, 0.5, max_iter=3, e_prob=0.5)
    # mine_obj = sgp.algorithms.AntGRAANK(dummy_df)
    # mine_obj = sgp.algorithms.GeneticGRAANK(dummy_df)
    # mine_obj = sgp.algorithms.HillClimbingGRAANK(dummy_df)
    # mine_obj = sgp.algorithms.RandomGRAANK(dummy_df)
    # mine_obj = sgp.algorithms.ParticleGRAANK(dummy_df)
    # mine_obj = sgp.algorithms.TGrad(dummy_df, target_col=1, min_sup=0.2, min_rep=0.1)
